...
<main class="main-content">
    ...
    <div class="overlay">
        ...
        <p>В нашем ресторане вы сможете насладиться истинными шедеврами французской кухни и погрузиться в атмосферу
            романтики Франции.</p>
    </div>
</main>
...
<section class="reservation">
    <form id="reservation-form">
        <div class="tex">
            ...
            <p>Забронируйте столик заранее, чтобы насладиться лучшими блюдами нашего шеф-повара и расположиться в уютной
                обстановке.</p>
        </div>
        <div class="forma">
        ...
        $('#reservation-form').on('submit', function(e) {
            ...
            $.ajax({
                ...
                success: function(response) {
                    $('#message').html('<p style="color: white;">' + response.success +
                        '</p>');
                ...
                error: function(xhr) {
                    if (xhr.status === 401) {
                        ...
                        let errorMessage =
                            '<p style="color: red;">Пожалуйста, исправьте следующие ошибки:</p><ul>';
                        $.each(errors, function(key, value) {
                            errorMessage += '<li>' + value[0] +
                            '</li>'; // Показываем только первое сообщение об ошибке
                        });
                        errorMessage += '</ul>';
...
<section class="about-us">
    <div class="about-content">
        <div class="contents">
            <h2>About Us</h2>
            <p>Ресторан «Paradis» — это уголок Франции в самом центре города. Мы приглашаем вас насладиться изысканными
                блюдами французской кухни, созданными из ингредиентов с вниманием к каждой детали. Каждое посещение —
                это уникальный гастрономический опыт, наполненный вкусами и ароматами, которые перенесут вас на улочки
                Парижа.</p>
        </div>
        <div>
...
<section class="highlights">
    ...
    <div class="highlight">
        ...
        <p>Наслаждайтесь нашими индивидуальными стендами, которые расположены в наших просторных, хорошо освещенных
            залах...</p>
    </div>
    <div class="highlight">
...
<section>
    <div class="contents-2">
        ...
        <p>Наши любимые гости регулярно возвращаются к нам, чтобы насладиться своими излюбленными блюдами. В связи с
            этим мы рады представить вам специальную подборку самых популярных у наших посетителей кулинарных шедевров!…
        </p>
    </div>
    <div class="keks">
...
<section class="kuhnya">
    ...
    <p>Мы очень гордимся тем, что тщательно подбираем ингредиенты для приготовления наших блюд, чтобы они были
        максимально вкусными и аутентичными. Мы можем достичь такого высокого уровня качества, только добавляя в наше
        меню особую тщательность, которую трудно найти в других ресторанах.</p>
    <div class="ingri">
...
<section class="povar">
    <div class="povar-text">
        ...
        <div class="povar-texts">
            <p>Уже в 16 лет, будучи еще школьником, Виктор впервые оказался на профессиональной кухне. Начав с роли
                помощника повара, он шаг за шагом постигал секреты ремесла, проходя все этапы — от повара до су-шефа,
                пока в 22 года не стал шефом. Этот стремительный путь говорит о его преданности делу, целеустремленности
                и таланте, которые помогают ему каждый день создавать настоящие шедевры.</p>
        </div>
    </div>
</section>
</section>
